...
| Affective state and emotional recall | 🧪 opt-in PAD state plus derived semantic/affective retrieval, with all model-facing behavior disabled by default ([docs/emotional-state.md](docs/emotional-state.md)) |
